        ...
        setContent {
            ...
            MaterialTheme {
                ZoomSessionScreen(
                    ...
                    talkRequests = vm.talkRequests.value,
                    talkPermissions = vm.talkPermissions.value,
                    isRequestingToTalk = vm.isRequestingToTalk.value,
                    onRequestToTalk = { vm.requestToTalk() },
                    onCancelTalkRequest = { vm.cancelTalkRequest() },
                    onApproveTalkRequest = { userId -> vm.approveTalkRequest(userId) },
                    onRevokeTalkPermission = { userId -> vm.revokeTalkPermission(userId) },
                    onDismissTalkRequest = { userId -> vm.dismissTalkRequest(userId) },
